export default function Home() {
  return (
    <main className="bg-white h-screen text-black m-7 rounded-3xl flex flex-row ">
      <div className="Herolefttext flex flex-col gap-6 m-20 justify-center w-150">
        ...
        <h2>
          ...
          tincidunt ac viverra ac, facilisis at justo. Donec vitae lorem ac odio
          vestibulum rhoncus. Quisque in iaculis purus.
        </h2>
